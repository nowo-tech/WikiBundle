 ...
 *     }>,
 * }
 * @psalm-type NowoWikiConfig = array{
 *     user_class?: scalar|Param|null, // FQCN of the application user entity.
 *     table_prefix?: scalar|Param|null, // Default: "wiki_"
 *     space_scope?: "team"|"user"|Param, // Default: "team"
 *     team_membership_resolver?: scalar|Param|null, // Default: null
 *     database?: array{
 *         driver?: scalar|Param|null, // Default: "doctrine_orm"
 *         platform?: scalar|Param|null, // Default: "mysql"
 ...
 *     editor?: array{
 *         tiptap_config?: scalar|Param|null, // Default: "notion"
 *     },
 *     security?: array{
 ...
 *         edit_roles?: list<scalar|Param|null>,
 *         history_roles?: list<scalar|Param|null>,
 *         archive_roles?: list<scalar|Param|null>,
 *         ai_roles?: list<scalar|Param|null>,
 *         import_roles?: list<scalar|Param|null>,
 *         export_roles?: list<scalar|Param|null>,
 *     },
 *     import_export?: array{
 *         enabled?: bool|Param, // Default: true
 *         max_upload_bytes?: int|Param, // Default: 52428800
 *     },
 *     ai?: array{
 *         enabled?: bool|Param, // Default: false
 *         agent?: scalar|Param|null, // Default: "wiki_assistant"
 *         context_injection?: bool|Param, // Inject search hits into the system prompt (in addition to optional agent tools). // Default: true
 *         max_context_pages?: int|Param, // Default: 8
 *         max_context_chars?: int|Param, // Default: 12000
 *         system_prompt?: scalar|Param|null, // Default: null
 *     },
 *     routes?: array{
 *         index?: array{
 *             path?: scalar|Param|null, // Default: "/tools/wiki"
 *             name?: scalar|Param|null, // Default: "nowo_wiki_index"
 *         },
 *         space?: array{
 *             path?: scalar|Param|null, // Default: "/tools/wiki/spaces/{spaceSlug}"
 *             name?: scalar|Param|null, // Default: "nowo_wiki_space"
 *         },
 *         page_view?: array{
 *             path?: scalar|Param|null, // Default: "/tools/wiki/spaces/{spaceSlug}/pages/{pageSlug}"
 *             name?: scalar|Param|null, // Default: "nowo_wiki_page_view"
 *         },
 *         page_edit?: array{
 *             path?: scalar|Param|null, // Default: "/tools/wiki/spaces/{spaceSlug}/pages/{pageSlug}/edit"
 *             name?: scalar|Param|null, // Default: "nowo_wiki_page_edit"
 *         },
 *         page_new?: array{
 *             path?: scalar|Param|null, // Default: "/tools/wiki/spaces/{spaceSlug}/pages/new"
 *             name?: scalar|Param|null, // Default: "nowo_wiki_page_new"
 *         },
 *         page_history?: array{
 *             path?: scalar|Param|null, // Default: "/tools/wiki/spaces/{spaceSlug}/pages/{pageSlug}/history"
 *             name?: scalar|Param|null, // Default: "nowo_wiki_page_history"
 *         },
 *         page_diff?: array{
 *             path?: scalar|Param|null, // Default: "/tools/wiki/spaces/{spaceSlug}/pages/{pageSlug}/diff"
 *             name?: scalar|Param|null, // Default: "nowo_wiki_page_diff"
 *         },
 *         page_archive?: array{
 *             path?: scalar|Param|null, // Default: "/tools/wiki/spaces/{spaceSlug}/pages/{pageSlug}/archive"
 *             name?: scalar|Param|null, // Default: "nowo_wiki_page_archive"
 *         },
 *         search?: array{
 *             path?: scalar|Param|null, // Default: "/tools/wiki/search"
 *             name?: scalar|Param|null, // Default: "nowo_wiki_search"
 *         },
 *         ai_ask?: array{
 *             path?: scalar|Param|null, // Default: "/tools/wiki/ask"
 *             name?: scalar|Param|null, // Default: "nowo_wiki_ai_ask"
 *         },
 *         space_export?: array{
 *             path?: scalar|Param|null, // Default: "/tools/wiki/spaces/{spaceSlug}/export"
 *             name?: scalar|Param|null, // Default: "nowo_wiki_space_export"
 *         },
 *         space_import?: array{
 *             path?: scalar|Param|null, // Default: "/tools/wiki/spaces/{spaceSlug}/import"
 *             name?: scalar|Param|null, // Default: "nowo_wiki_space_import"
 *         },
 *     },
 *     templates?: array{
 *         layout?: scalar|Param|null, // Default: "@NowoWikiBundle/layout.html.twig"
 *         index?: scalar|Param|null, // Default: "@NowoWikiBundle/manage/index.html.twig"
 *         space?: scalar|Param|null, // Default: "@NowoWikiBundle/manage/space.html.twig"
 *         page_view?: scalar|Param|null, // Default: "@NowoWikiBundle/manage/page_view.html.twig"
 *         page_edit?: scalar|Param|null, // Default: "@NowoWikiBundle/manage/page_edit.html.twig"
 *         page_history?: scalar|Param|null, // Default: "@NowoWikiBundle/manage/page_history.html.twig"
